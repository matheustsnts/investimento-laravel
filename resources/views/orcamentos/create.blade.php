    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-2">
        <div>
            ...
            <p class="text-muted mb-0">
                Defina seu salário, dízimo e a distribuição por categorias para este mês.
            </p>
        </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body p-3 p-md-4">
                        ...
                        {{-- Salário líquido calculado (só exibição) --}}
                        <div class="mb-0">
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body p-3 p-md-4">
                        ...
                        <p class="text-muted mb-3">
                            Defina quantos % do salário líquido vão para cada categoria. A soma deve ser <strong>100%</strong>.
                        </p>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                           ...
                                           min="0"
                                           max="100"
                                           value="{{ old('percentual_investimentos') }}"
                                           required>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                           ...
                                           min="0"
                                           max="100"
                                           value="{{ old('percentual_custos_fixos') }}"
                                           required>
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                           ...
                                           min="0"
                                           max="100"
                                           value="{{ old('percentual_conhecimento') }}"
                                           required>
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
...
<script>
    ...
    function atualizarSomaPercentuais() {
        ...
        // Deixa visualmente diferente se não for 100%
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Atualiza valores iniciais se já tiver old()
